...
Route::any('/post', [App\Http\Controllers\postcountroller::class, 'ladox'])->name('post.ladox')->middleware('auth');;
...
Route::delete('/post/{post}', [App\Http\Controllers\postcountroller::class, 'delete'])->name('post.detele')->middleware('auth');;
...
Route::get('/ami', [App\Http\Controllers\amicountroller::class, 'index'])->name('index.ami')->middleware('auth');


Route::post('/Archive', [App\Http\Controllers\ArchiveController::class, 'index'])->middleware('auth')->name('Archive');
Route::any('/Ar', [App\Http\Controllers\ArchiveController::class, 'archive'])->middleware('auth')->name('Ar');
Route::delete('/Ar/{ok}',[App\Http\Controllers\ArchiveController::class, 'delte'])->middleware('auth')->name('Ar.delte');
